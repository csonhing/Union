...
def zoom_out4(x):
    ...
    time.sleep(x)
    webUrl= urllib.request.urlopen('http://172.31.0.67/ajaxcom?szCmd={"SysCtrl":{"PtzCtrl":{"nChanel":0,"szPtzCmd":"z"zoomdec_stop,"byValue":50}}}')
    return print("result code: " + str(webUrl.getcode()))
...
def zoom_out5(x):
    ...
    time.sleep(x)
    webUrl= urllib.request.urlopen('http://172.31.0.69/ajaxcom?szCmd={"SysCtrl":{"PtzCtrl":{"nChanel":0,"szPtzCmd":"z"zoomdec_stop,"byValue":50}}}')
    return print("result code: " + str(webUrl.getcode()))
...
def zoom_out6(x):
    ...
    time.sleep(x)
    webUrl= urllib.request.urlopen('http://172.31.0.68/ajaxcom?szCmd={"SysCtrl":{"PtzCtrl":{"nChanel":0,"szPtzCmd":"z"zoomdec_stop,"byValue":50}}}')
    return print("result code: " + str(webUrl.getcode()))
